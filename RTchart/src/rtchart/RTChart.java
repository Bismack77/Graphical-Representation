...
//////////////////////////////////////////////////////////////////////////
public class RTChart extends JApplet implements ActionListener
{
 ...
 DatagramSocket ds;
  ...
  public RTChart()
  {
     ...
     try {
          this.ds = new DatagramSocket(4567);
      } catch (SocketException ex) {
          Logger.getLogger(RTChart.class.getName()).log(Level.SEVERE, null, ex);
      }
  ...
  //////////////////////////////////////////////////////////////////////
   ...
   class HListener implements GlgHListener
   {
      public void HCallback( GlgObject viewport )
      {
         ...
         viewport.SetDResource( "Chart1/NumPlots", NUM_PLOTS );
         viewport.SetDResource( "Chart2/NumPlots", NUM_PLOTS );
         // Set Time Span for the X axis.
         viewport.SetDResource( "Chart/XAxis/Span", TimeSpan );
         viewport.SetDResource( "Chart1/XAxis/Span", TimeSpan );
          viewport.SetDResource( "Chart2/XAxis/Span", TimeSpan );
         ...
         viewport.SetDResource( "Chart/XAxis/MinorInterval", minor_interval );
            viewport.SetDResource( "Chart1/XAxis/MajorInterval", major_interval );
         viewport.SetDResource( "Chart1/XAxis/MinorInterval", minor_interval );
         viewport.SetDResource( "Chart2/XAxis/MajorInterval", major_interval );
         viewport.SetDResource( "Chart2/XAxis/MinorInterval", minor_interval );
         ...
         viewport.SetDResource( "Chart/YAxis/High", High );
          viewport.SetDResource( "Chart1/YAxis/Low", Low );
         
         viewport.SetDResource( "Chart1/YAxis/High", High );
         viewport.SetDResource( "Chart2/YAxis/Low", Low );
         viewport.SetDResource( "Chart2/YAxis/High", High );
      }
   }
   ...
   class VListener implements GlgVListener
   {
      public void VCallback( GlgObject viewport )
      {
         ...
         Plots = new GlgObject[ NUM_PLOTS ];
           Plots1 = new GlgObject[ NUM_PLOTS ];
         Plots2=new GlgObject[NUM_PLOTS];
         ...
         for( i=0; i<NUM_PLOTS; ++i )
         {
            ...
            Plots[i] = viewport.GetNamedPlot( "Chart", "Plot#" + i ); 
               if(i==1)
             {
                 Plots1[i] = viewport.GetNamedPlot( "Chart1", "Plot#" + i ); 
             }
             if(i==2)
             {
                 Plots2[i] = viewport.GetNamedPlot( "Chart2", "Plot#" + i ); 
             }
         ...
         if( num_plots_drawing < NUM_PLOTS )
           for( i=num_plots_drawing; i < NUM_PLOTS; ++i )
           {
              // Using a random color for a demo.
               if(i==0||i==1)
               {
                   Plots[i].SetGResource( "EdgeColor", 0.606973, 
                                     0., 
                                     0.429191 );
              Plots[i].SetSResource( "Annotation", "Var" + i );
               ...
               {
                   Plots1[i].SetGResource( "EdgeColor", 0.606973, 
                                     0., 
                                     0.429191 );
              Plots1[i].SetSResource( "Annotation", "Var" + i );
               }
               else
               {
                   Plots2[i].SetGResource( "EdgeColor", 0.606973, 
                                     0., 
                                     0.429191 );
              Plots2[i].SetSResource( "Annotation", "Var" + i );
               }
   ...
   ///////////////////////////////////////////////////////////////////////
   void UpdateGraphProc() throws IOException
   {
   ...
   ///////////////////////////////////////////////////////////////////////
   void GetChartData( double time_stamp, boolean use_current_time ) throws IOException
   {
      double value;
...
//               double p2=       
         ...
         value = Double.parseDouble(pac);
          
         // Supply plot value for the chart via ValueEntryPoint.
         if(i==0)
         Plots[i].SetDResource( "ValueEntryPoint", value );
         else if(i==1)
         Plots1[i].SetDResource( "ValueEntryPoint", value );
         else 
         Plots2[i].SetDResource( "ValueEntryPoint", value );
         ...
         {   
            ...
            Plots1[i].SetDResource( "TimeEntryPoint", time_stamp );
             else
                 Plots2[i].SetDResource( "TimeEntryPoint", time_stamp );
         ...
         Plots1[i].SetDResource( "ValidEntryPoint", 1. /*valid*/ );
         else
         {
             Plots2[i].SetDResource( "ValidEntryPoint", 1. /*valid*/ );
         }
      }
   }
